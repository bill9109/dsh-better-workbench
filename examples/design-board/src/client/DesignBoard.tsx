...
const SECTION_GROUPS: readonly SectionGroup[] = [
  {
    label: '总览',
    sections: [{ id: 'overview', label: '系统总览', icon: IconPanelLeftOutlineRegular }],
  },
  {
    label: '基础资源',
    sections: [
      { id: 'foundations', label: '颜色与字体', icon: IconPersonalizationOutlineRegular },
      { id: 'icons', label: '图标', icon: IconListPenOutlineRegular },
      { id: 'primitives', label: '基础组件', icon: IconPlusOutlineRegular },
    ],
  },
  {
    label: '规范',
    sections: [
      { id: 'states', label: '状态与响应式', icon: IconLoadingOutlineRegular },
      { id: 'accessibility', label: '无障碍', icon: IconCheckOutlineRegular },
      { id: 'governance', label: '实现记录', icon: IconInspectOutlineRegular },
    ],
  },
  {
    label: '产品页面',
    sections: [
      { id: 'shell', label: '应用框架', icon: IconPanelLeftOutlineRegular },
      { id: 'sidebar', label: '侧边栏', icon: IconFolderOpenRegular },
      { id: 'settings', label: '设置弹窗', icon: IconSettingsOutlineRegular },
      { id: 'session', label: '会话标题栏', icon: IconAgentPresetOutlineRegular },
      { id: 'chat', label: '对话流', icon: IconNewChatOutlineRegular },
      { id: 'composer', label: '输入区', icon: IconPlusOutlineRegular },
      { id: 'trajectory', label: '轨迹', icon: IconDataOutlineRegular },
      { id: 'overlays', label: '浮层与全局反馈', icon: IconWarningOutlineRegular },
    ],
  },
]
...
const ICON_GROUPS: ReadonlyArray<{ title: string; icons: ReadonlyArray<{ label: string; name: string; icon: BoardIcon; size: number; usage: string }> }> = [
  {
    title: '导航、工作区与设置',
    icons: [
      { label: '新建会话', name: 'IconNewChatOutlineRegular', icon: IconNewChatOutlineRegular, size: 16, usage: '侧边栏和对话标题栏的新会话入口' },
      { label: '搜索', name: 'IconSearchOutlineRegular', icon: IconSearchOutlineRegular, size: 16, usage: '工作区筛选和搜索入口' },
      { label: '视图选项', name: 'IconPersonalizationOutlineRegular', icon: IconPersonalizationOutlineRegular, size: 16, usage: '工作区标题栏的视图选项' },
      { label: '添加工作区', name: 'IconProjectAddOutlineRegular', icon: IconProjectAddOutlineRegular, size: 16, usage: '工作区标题栏添加工作区' },
      { label: '更多操作', name: 'IconEllipsisOutlineRegular', icon: IconEllipsisOutlineRegular, size: 16, usage: '列表行操作菜单触发' },
      { label: '侧栏', name: 'IconPanelLeftOutlineRegular', icon: IconPanelLeftOutlineRegular, size: 16, usage: '应用框架收起和展开侧栏' },
      { label: '网络', name: 'IconGlobeOutlineRegular', icon: IconGlobeOutlineRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '设置', name: 'IconSettingsOutlineRegular', icon: IconSettingsOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '完成', name: 'IconCheckOutlineRegular', icon: IconCheckOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '分支', name: 'IconBranchOutlineRegular', icon: IconBranchOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '向下', name: 'IconChevronDownOutlineRegular', icon: IconChevronDownOutlineRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '向左', name: 'IconChevronLeftOutlineRegular', icon: IconChevronLeftOutlineRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '向右', name: 'IconChevronRightOutlineRegular', icon: IconChevronRightOutlineRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '展开', name: 'IconTriangleRightFillRegular', icon: IconTriangleRightFillRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '向上', name: 'IconChevronUpOutlineRegular', icon: IconChevronUpOutlineRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '关闭', name: 'IconCloseOutlineRegular', icon: IconCloseOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '关闭（填充）', name: 'IconCloseFillRegular', icon: IconCloseFillRegular, size: 14, usage: '导航、工作区、设置和浮层动作' },
      { label: '刷新', name: 'IconRefreshOutlineRegular', icon: IconRefreshOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '分享', name: 'IconShareOutlineRegular', icon: IconShareOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '编辑', name: 'IconEditOutlineRegular', icon: IconEditOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '浏览', name: 'IconBrowseOutlineRegular', icon: IconBrowseOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '链接', name: 'IconLinkOutlineRegular', icon: IconLinkOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '外部链接', name: 'IconRightUpOutlineRegular', icon: IconRightUpOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '增强', name: 'IconEnhanceOutlineRegular', icon: IconEnhanceOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '轮廓文件夹', name: 'IconFolderOpenOutlineRegular', icon: IconFolderOpenOutlineRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '打开文件夹', name: 'IconFolderOpenRegular', icon: IconFolderOpenRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '关闭文件夹', name: 'IconFolderCloseRegular', icon: IconFolderCloseRegular, size: 16, usage: '导航、工作区、设置和浮层动作' },
      { label: '树节点连接', name: 'IconTreeCornerRegular', icon: IconTreeCornerRegular, size: 10, usage: '导航、工作区、设置和浮层动作' },
    ],
  },
  {
    title: '对话、反馈与运行状态',
    icons: [
      { label: '添加内容', name: 'IconPlusOutlineRegular', icon: IconPlusOutlineRegular, size: 16, usage: 'Composer 添加附件、任务或上下文' },
      { label: '发送', name: 'IconSendOutlineRegular', icon: IconSendOutlineRegular, size: 16, usage: 'Composer 发送消息' },
      { label: '复制', name: 'IconCopyOutlineRegular', icon: IconCopyOutlineRegular, size: 16, usage: '助手消息复制操作' },
      { label: '赞同', name: 'IconLikeOutlineRegular', icon: IconLikeOutlineRegular, size: 16, usage: '助手消息正向反馈' },
      { label: '赞同（填充）', name: 'IconLikeFillRegular', icon: IconLikeFillRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '不赞同', name: 'IconDislikeOutlineRegular', icon: IconDislikeOutlineRegular, size: 16, usage: '助手消息负向反馈' },
      { label: '不赞同（填充）', name: 'IconDislikeFillRegular', icon: IconDislikeFillRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '思考', name: 'IconThinkOutlineRegular', icon: IconThinkOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '用户', name: 'IconUserOutlineRegular', icon: IconUserOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '上下文注入', name: 'IconContextInjectionOutlineRegular', icon: IconContextInjectionOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '附件', name: 'IconPaperclipOutlineRegular', icon: IconPaperclipOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '停止', name: 'IconStopFillRegular', icon: IconStopFillRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '加载', name: 'IconLoadingOutlineRegular', icon: IconLoadingOutlineRegular, size: 16, usage: '加载或等待状态' },
      { label: '警告', name: 'IconWarningOutlineRegular', icon: IconWarningOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '下载', name: 'IconDownloadOutlineRegular', icon: IconDownloadOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '播放', name: 'IconPlayOutlineRegular', icon: IconPlayOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '暂停', name: 'IconPauseOutlineRegular', icon: IconPauseOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
      { label: '全屏', name: 'IconFullscreenOutlineRegular', icon: IconFullscreenOutlineRegular, size: 16, usage: '对话流、Composer 和反馈动作' },
    ],
  },
  {
    title: '能力、主题、数据与任务',
    icons: [
      { label: '工具代码', name: 'IconCodeOutlineRegular', icon: IconCodeOutlineRegular, size: 16, usage: '工具行和代码结果的 leading icon' },
      { label: 'Agent 预设', name: 'IconAgentPresetOutlineRegular', icon: IconAgentPresetOutlineRegular, size: 16, usage: '设置、会话标题栏和预设选择' },
      { label: '插件', name: 'IconCordisPluginOutlineRegular', icon: IconCordisPluginOutlineRegular, size: 14, usage: '设置中的插件入口或插件状态' },
      { label: 'API', name: 'IconApiOutlineRegular', icon: IconApiOutlineRegular, size: 14, usage: '设置、能力、任务和轨迹' },
      { label: '目标', name: 'IconGoalOutlineRegular', icon: IconGoalOutlineRegular, size: 16, usage: 'Goal 面板入口' },
      { label: '技能', name: 'IconSkillOutlineRegular', icon: IconSkillOutlineRegular, size: 16, usage: 'Skill 面板入口' },
      { label: '浅色', name: 'IconLightOutlineRegular', icon: IconLightOutlineRegular, size: 16, usage: '主题设置的浅色选项' },
      { label: '深色', name: 'IconDarkOutlineRegular', icon: IconDarkOutlineRegular, size: 16, usage: '主题设置的深色选项' },
      { label: '跟随系统', name: 'IconFollowsystemOutlineRegular', icon: IconFollowsystemOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '删除', name: 'IconTrashOutlineRegular', icon: IconTrashOutlineRegular, size: 16, usage: '删除工作区等破坏性动作' },
      { label: '数据', name: 'IconDataOutlineRegular', icon: IconDataOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '数据库', name: 'IconDatabaseOutlineRegular', icon: IconDatabaseOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '时间', name: 'IconClockOutlineRegular', icon: IconClockOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '队列', name: 'IconQueueOutlineRegular', icon: IconQueueOutlineRegular, size: 14, usage: '设置、能力、任务和轨迹' },
      { label: '清单', name: 'IconChecklistOutlineRegular', icon: IconChecklistOutlineRegular, size: 14, usage: '设置、能力、任务和轨迹' },
      { label: '列表', name: 'IconListPenOutlineRegular', icon: IconListPenOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '智能增强', name: 'IconSparkleRegular', icon: IconSparkleRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '检查', name: 'IconInspectOutlineRegular', icon: IconInspectOutlineRegular, size: 12, usage: '设置、能力、任务和轨迹' },
      { label: '帮助', name: 'IconQuestionOutlineRegular', icon: IconQuestionOutlineRegular, size: 14, usage: '设置、能力、任务和轨迹' },
      { label: '定时', name: 'IconAlarmClockOutlineRegular', icon: IconAlarmClockOutlineRegular, size: 16, usage: '设置、能力、任务和轨迹' },
      { label: '归档', name: 'IconArchiveOutlineRegular', icon: IconArchiveOutlineRegular, size: 20, usage: '设置、能力、任务和轨迹' },
    ],
  },
]
...
function Overview(): JSX.Element {
  return <div className="dsh-specimen-content">
    ...
    <section className="dsh-specimen-band">
      ...
      <div className="dsh-overview-page-map"><div><IconPanelLeftOutlineRegular /><strong>应用框架</strong><span>安排侧边栏、主内容和右侧详情，提供列宽调整与全局浮层位置。</span></div><div><IconFolderOpenRegular /><strong>侧边栏</strong><span>品牌、收起、新会话、工作台、工作区、会话树和设置入口。</span></div><div><IconSettingsOutlineRegular size={14} /><strong>设置弹窗</strong><span>通用、模型、插件和 Agent 预设；每项配置拥有独立状态。</span></div><div><IconAgentPresetOutlineRegular /><strong>会话标题栏</strong><span>父子路径、预设、子代理、后台任务与视图页签；工具可由插件追加。</span></div><div><IconNewChatOutlineRegular /><strong>对话流</strong><span>用户与助手消息、思考过程、工具调用、结果和会话反馈。</span></div><div><IconPlusOutlineRegular /><strong>输入区</strong><span>任务、目标、队列、附件、模式、模型、上下文、发送和会话统计。</span></div><div><IconDataOutlineRegular /><strong>轨迹</strong><span>时间概览、搜索、轮次和工具折叠、事件账本、历史加载与记录检查。</span></div><div><IconWarningOutlineRegular /><strong>浮层与反馈</strong><span>菜单、确认、提示、连接状态和错误反馈；各自有不同的关闭方式与层级。</span></div></div>
    </section>
    <section className="dsh-specimen-band">
      <SectionHeading title="一致性原则" detail="组件先于页面。页面选择组件、变体与排列方式，不在局部重新定义控件自身的视觉。" />
      <div className="dsh-board-callouts"><div><IconCheckOutlineRegular size={14} /><strong>同一角色，同一变体</strong><span>添加工作台与添加工作区都是标题栏添加按钮，统一为 28×28 的圆形图标按钮，并共享全部交互状态。</span></div><div><IconInspectOutlineRegular size={12} /><strong>差异必须有语义</strong><span>只有功能或约束确实不同，才选择另一个已命名变体；例如 28px 标题栏按钮与 36px rail 按钮。</span></div><div><IconWarningOutlineRegular /><strong>页面不能改写组件</strong><span>页面负责位置、间距和响应式编排；字号、内边距、边界、圆角、图标与状态由组件变体持有。</span></div></div>
    </section>
    <section className="dsh-specimen-band">
...
function Shell(): JSX.Element {
  return <div className="dsh-specimen-content"><BoardIntro path="产品页面 / 应用框架" title="应用框架">应用框架只负责侧边栏、主内容、详情区和全局浮层的页面关系，也持有列宽、收起与拖拽状态。消息、Composer、轨迹和设置仍由各自页面定义。</BoardIntro><section className="dsh-specimen-band"><SectionHeading title="布局规则" source="ui-layout/AppFrame.tsx + ui-sidebar/SidebarRoot.tsx" detail="页面先遵循列宽与收起规则，再把产品模块放进对应区域；应用框架不改变内部组件变体。" /><div className="dsh-shell-rule-table">{SHELL_RULES.map(([title, value, detail]) => <div key={title}><strong>{title}</strong><code>{value}</code><span>{detail}</span></div>)}</div></section><section className="dsh-specimen-band"><SectionHeading title="三列布局" detail="侧边栏、主内容和详情区保持独立；详情区可归零，overlay 使用绝对层。" /><div className="dsh-shell-diagram"><aside><span>侧边栏</span><strong>264–420px</strong><small>default 280 · rail 56</small></aside><main><header><span>主内容</span><span>标题栏 + 当前视图 + Composer</span></header><div className="dsh-shell-chat-lines"><span /><span /><span /></div><div className="dsh-shell-composer-line" /></main><div className="dsh-shell-resize-handle" aria-hidden="true" /><aside className="dsh-shell-details"><span>详情区</span><strong>0 / 300–520px</strong><small>reopen 360 · hit strip 8</small></aside><div className="dsh-shell-overlay"><IconInspectOutlineRegular size={12} /><span>全局浮层 · z20 · 根层不拦截点击</span></div></div></section><section className="dsh-specimen-band"><SectionHeading title="框架状态" detail="页面框架根据视口和用户操作切换列状态，同时保留主内容和关键入口。" /><div className="dsh-shell-state-grid"><div><IconPanelLeftOutlineRegular /><strong>宽侧栏</strong><span>侧边栏内容可见，工作区树和设置入口保持完整。</span></div><div><IconPanelLeftOutlineRegular /><strong>56px rail</strong><span>1024px 以下自动收起；保留品牌、新会话、工作区和设置入口。</span></div><div><IconInspectOutlineRegular size={12} /><strong>详情关闭 / 打开</strong><span>关闭为 0；重新打开 360px，再在 300–520px 内拖拽。</span></div><div><IconCodeOutlineRegular /><strong>全局浮层</strong><span>根层 click-through，Toast、Banner 等子项按需要恢复交互。</span></div></div></section></div>
}
function Conversation(): JSX.Element {
  return <div className="dsh-specimen-content"><BoardIntro path="产品页面 / 对话流" title="对话流">对话流负责按时间阅读用户、助手、思考、工具、上下文和错误信息。它在会话的单一滚动轴内工作；Composer 及其 Todo、Goal、Queue dock 由“输入区”页面定义。</BoardIntro><section className="dsh-specimen-band"><SectionHeading title="阅读与滚动规则" source="ui-conversation/ChatView.tsx + ConversationRoot.tsx" detail="对话流保持稳定列宽和阅读位置；加载历史、运行状态与回到底部各自有明确位置和行为。" /><div className="dsh-chat-rule-table">{CHAT_FLOW_RULES.map(([title, value, detail]) => <div key={title}><strong>{title}</strong><code>{value}</code><span>{detail}</span></div>)}</div></section><section className="dsh-specimen-band"><SectionHeading title="完整消息流" detail="所有内容以 16px vertical rhythm 排列；每个节点保留其业务身份，而不是套进同一种卡片。" /><div className="dsh-chat-flow-specimen"><div className="dsh-chat-flow-column"><div className="dsh-chat-load-older"><button type="button">加载更早历史</button></div><div className="dsh-chat-context-row"><IconInspectOutlineRegular size={12} /><span>已压缩 409 条历史记录</span><i /><small>展开查看摘要</small></div><div className="dsh-chat-user-row"><div className="dsh-chat-user-bubble">请按真实 DSH 模块重构样式看板。</div></div><article className="dsh-chat-assistant"><p>我会先确认组件归属、状态和页面关系，再把重复控件收敛为同一个命名变体。</p><div className="dsh-module-message-actions"><button type="button" aria-label="复制"><IconCopyOutlineRegular /></button><button type="button" aria-label="赞同"><IconLikeOutlineRegular /></button><button type="button" aria-label="不赞同"><IconDislikeOutlineRegular /></button></div></article><div className="dsh-chat-reasoning" data-running="true"><IconThinkOutlineRegular size={14} /><strong>思考中</strong><i /><span>正在整理模块之间的关系</span><IconChevronDownOutlineRegular size={14} /></div><div className="dsh-chat-tool"><IconCodeOutlineRegular /><strong>读取</strong><i /><span>ui-conversation/chat/ChatView.tsx</span><IconChevronDownOutlineRegular size={14} /></div><div className="dsh-chat-error"><span /><div><strong>本轮未完成</strong><span>读取记录时出现错误</span><code>open-error</code></div><button type="button">重试</button></div><div className="dsh-chat-turn-status">深度求索中...<span>15秒</span></div><div className="dsh-chat-pending">待发送消息：继续核对轨迹页面。</div><div className="dsh-chat-stats">25 轮 · 741 步<i />LLM 325分7秒<i />工具调用 14分7秒<i />输入 124M tok · 输出 333K tok</div></div><button type="button" className="dsh-chat-to-bottom" aria-label="回到最新消息"><IconChevronDownOutlineRegular size={14} /></button></div></section><section className="dsh-specimen-band"><SectionHeading title="Composer dock 的相邻关系" detail="Todo、Goal、Queue 是输入区上方的按序贡献，不属于消息流节点；它们共享会话内容宽度轴但各自按有无数据出现。" /><div className="dsh-chat-dock-order"><div><strong>Todo</strong><code>order 0</code><span>计划投影存在时显示。</span></div><div><strong>Goal</strong><code>order 10</code><span>当前目标投影存在时显示。</span></div><div><strong>Queue</strong><code>order 20</code><span>会话队列存在时显示。</span></div><div><strong>快速跳转轨</strong><code>当前无 native 实现</code><span>不能在产品页假设存在；需要先定义所有权、键盘路径和阅读锚点。</span></div></div></section></div>
}
...
function Sidebar(): JSX.Element {
  return <div className="dsh-specimen-content"><BoardIntro path="产品页面 / 侧边栏" title="侧边栏">侧边栏负责身份入口、收起和新会话；下方再分成工作台、工作区、会话树和设置。宽侧栏和 56px 收起栏是同一套结构的两种呈现。</BoardIntro>
    ...
    <section className="dsh-specimen-band"><SectionHeading title="宽侧栏" detail="品牌、收起、新会话和工作区共同组成左侧导航；工作台与工作区标题行使用同一组图标按钮。" /><div className="dsh-sidebar-specimen"><div className="dsh-sidebar-brand"><BrandWordmark /><button type="button" aria-label="收起侧边栏"><IconPanelLeftOutlineRegular /></button></div><button type="button" className="dsh-sidebar-new"><IconNewChatOutlineRegular /><span>新会话</span></button><div className="dsh-sidebar-section-title"><strong>工作台</strong><div><button type="button" aria-label="搜索工作台"><IconSearchOutlineRegular /></button><button type="button" aria-label="添加工作台"><IconProjectAddOutlineRegular /></button></div></div><div className="dsh-sidebar-workbench"><IconCordisPluginOutlineRegular size={14} /><strong>DSH UI 样式看板</strong><IconEllipsisOutlineRegular /></div><div className="dsh-sidebar-section-title"><strong>工作区</strong><div><button type="button" aria-label="搜索会话"><IconSearchOutlineRegular /></button><button type="button" aria-label="添加工作区"><IconProjectAddOutlineRegular /></button></div></div><div className="dsh-sidebar-project"><IconFolderOpenRegular /><strong>AI 项目</strong><IconEllipsisOutlineRegular /></div><div className="dsh-sidebar-rename"><button type="button"><IconEditOutlineRegular /><span>重命名</span></button><hr /><button type="button" className="is-danger"><IconTrashOutlineRegular /><span>删除</span></button></div><button type="button" className="dsh-sidebar-session" data-selected="true"><IconPlayOutlineRegular /><span>分析工作区插件层级与功能</span><time>刚刚</time></button><button type="button" className="dsh-sidebar-session"><span className="dsh-sidebar-session-empty" /><span>DSH Cordis 插件开发规范</span><time>8小时</time></button></div></section>
    <section className="dsh-specimen-band"><SectionHeading title="收起与列表状态" detail="收起后只保留可继续操作的入口；列表行的选中、运行、悬停菜单和重命名都需要单独处理。" /><div className="dsh-sidebar-state-grid"><div><IconPanelLeftOutlineRegular /><strong>56px rail</strong><span>Logo、展开、新会话和设置使用图标入口。</span></div><div><IconPlayOutlineRegular /><strong>进行中会话</strong><span>状态点、子代理数量和当前会话标题同时出现。</span></div><div><IconEditOutlineRegular /><strong>重命名与删除</strong><span>工作区菜单使用统一行高和图标槽；删除使用 danger 状态，不新增不存在的操作。</span></div><div><IconSearchOutlineRegular /><strong>搜索与空列表</strong><span>搜索工作台、搜索会话、无结果和加载状态不改变树的行高。</span></div></div></section>
  </div>
}
...
function Trajectory(): JSX.Element {
  ...
  return <div className="dsh-specimen-content"><BoardIntro path="产品页面 / 轨迹" title="轨迹">轨迹是独立的会话视图，用时间概览和事件账本展示模型、工具和上下文的执行过程。它有自己的工具栏、滚动区、搜索、折叠、历史分页和记录检查器，不等同于对话里的工具行。</BoardIntro><section className="dsh-specimen-band"><SectionHeading title="布局与交互规则" source="ui-trajectory/TrajectoryView.tsx + TrajectoryToolbar.tsx + TrajectoryTimeline.tsx + TrajectoryTable.tsx" detail="工具栏、时间概览、事件账本和记录检查器各自承担不同的阅读任务，统一由轨迹视图管理滚动和选择。" /><div className="dsh-trajectory-rule-table">{TRAJECTORY_RULES.map(([title, value, detail]) => <div key={title}><strong>{title}</strong><code>{value}</code><span>{detail}</span></div>)}</div></section>
    <section className="dsh-specimen-band"><SectionHeading title="时间概览与工具栏" detail="顶部固定工具栏负责时间宽度、轮次/工具折叠和搜索；时间概览用 Input、Model、Tools 三条轨道表达真实耗时。" /><div className="dsh-trajectory-frame"><div className="dsh-trajectory-toolbar"><button type="button" data-active="true"><IconPlayOutlineRegular />Duration</button><button type="button"><IconChevronDownOutlineRegular size={14} />Turns</button><button type="button"><IconChevronDownOutlineRegular size={14} />Calls</button><label><IconSearchOutlineRegular /><input aria-label="搜索轨迹" placeholder="Search" readOnly /></label></div><div className="dsh-trajectory-timeline"><div className="dsh-trajectory-lanes"><span>Input</span><span>Model</span><span>Tools</span></div><div className="dsh-trajectory-bars"><i className="is-input" /><i className="is-model" /><i className="is-tool" /><i className="is-error" /><small>TTFT 1.3s · decode 1.1s</small></div></div><div className="dsh-trajectory-body"><div className="dsh-trajectory-ledger"><div className="dsh-trajectory-load-earlier">… 加载更早历史</div>{rows.map(([index, kind, text, time]) => <div className={`dsh-trajectory-row kind-${kind.toLowerCase()}`} key={index}><span className="dsh-trajectory-event"><b>{index}</b><em>{kind}</em></span><span className="dsh-trajectory-content">{text}</span><time>{time}</time></div>)}<div className="dsh-trajectory-turn-break"><span>Turn 25</span><i /><small>3 steps · 2 tool calls</small></div><div className="dsh-trajectory-row is-selected"><span className="dsh-trajectory-event"><b>#135</b><em>TOOL</em></span><span className="dsh-trajectory-content">Bash · pnpm run check → Typecheck passed</span><time>1.8s</time></div></div><aside className="dsh-trajectory-inspector"><header><strong>Record #135</strong><button type="button" aria-label="关闭记录检查器"><IconCloseFillRegular size={14} /></button></header><nav><button type="button" data-active="true">Summary</button><button type="button">Payload</button><button type="button">Result</button><button type="button">Timing</button></nav><div className="dsh-trajectory-inspector-body"><dl><div><dt>Event</dt><dd>TOOL / Bash</dd></div><div><dt>Status</dt><dd className="is-success">Completed</dd></div><div><dt>Duration</dt><dd>1.8s</dd></div><div><dt>Request</dt><dd>Request #24</dd></div></dl><h4>Result</h4><pre>Typecheck passed\n0 errors</pre></div></aside></div></div></section>
