window.__ModuleLoader__.load({
	id: "dsh-better-workbench-skill-mcp-panels",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		const react_jsx_runtime$1 = react_jsx_runtime;
		const react$1 = react;
			...
			descriptors: [
				{
					...
					parameters: [{
						...
						codec: codec("dsh-skill-mcp-panel#sessionId")
					}],
					...
					parameters: [
						{
							...
							wire: "name",
							source: "json",
							codec: codec("dsh-skill-mcp-panel#SkillName")
						},
						{
							name: "sessionId",
							wire: "sessionId",
						...
						},
						{
							...
							wire: "payload",
							source: "json",
							codec: codec("dsh-skill-mcp-panel#MigratePayload")
						}
					],
				...
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#BatchMigratePayload")
					}],
				...
				},
				{
					...
					parameters: [
						...
						},
						{
							...
							source: "json",
							acceptsUndefined: true,
							codec: codec("dsh-skill-mcp-panel#SkillScope")
						}
					],
				...
				},
				{
					...
					parameters: [
						...
						},
						{
							...
							wire: "enabled",
							source: "json",
							codec: codec("dsh-skill-mcp-panel#EnabledFlag")
						},
						{
							name: "scope",
							wire: "scope",
				...
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#AddPayload")
					}],
				...
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#McpSavePayload")
					}],
				...
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#McpRemovePayload")
					}],
				...
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#McpSetEnabledPayload")
					}],
					result: codec("dsh-skill-mcp-panel#McpSaveResult")
				},
				{
					...
					parameters: [{
						...
						wire: "payload",
						source: "json",
						codec: codec("dsh-skill-mcp-panel#McpTestPayload")
					}],
		...
		function MigrateDialog({ t, options, from, setFrom, targets, toggleTarget, mode, setMode, skills, selected, toggle, selectAll, busy, result, error, onConfirm, onCancel, onClose }) {
			...
			const targetLabelOf = (value) => {
				if (value === null || value === void 0 || value === "global") return t("scopeGlobal");
				const hit = known.find((option) => option.path === value);
				return hit !== void 0 && typeof hit.label === "string" && hit.label !== "" ? hit.label : value;
			};
			return (0, react_jsx_runtime$1.jsx)("div", {
				className: c.scopeOverlay,
				role: "dialog",
				"aria-modal": "true",
				children: (0, react_jsx_runtime$1.jsxs)("div", {
					className: c.scopeBox,
					children: [
						(0, react_jsx_runtime$1.jsx)("h4", { children: t("migrateTitle") }),
						(0, react_jsx_runtime$1.jsxs)("div", {
							className: c.field,
							children: [
								(0, react_jsx_runtime$1.jsx)("label", {
									className: c.fieldLabel,
									children: t("migrateFrom")
								}),
								(0, react_jsx_runtime$1.jsxs)("div", {
									className: c.targetBox,
									children: [(0, react_jsx_runtime$1.jsxs)("button", {
										type: "button",
										...
										children: [(0, react_jsx_runtime$1.jsx)("input", {
											type: "radio",
											name: "migrate-from",
											checked: from === "global",
											readOnly: true
									...
									}, "from-global"), ...known.map((option) => (0, react_jsx_runtime$1.jsxs)("button", {
										type: "button",
										className: c.targetItem,
								...
								from === "" ? (0, react_jsx_runtime$1.jsx)("p", {
						...
						(0, react_jsx_runtime$1.jsxs)("div", {
							className: c.field,
							children: [(0, react_jsx_runtime$1.jsx)("label", {
								className: c.fieldLabel,
								...
								}), ...known.map((option) => (0, react_jsx_runtime$1.jsxs)("button", {
									type: "button",
									className: c.targetItem,
						...
						mode === "move" && targets.size > 1 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.migrateHint,
							children: t("migrateMoveSingle")
						}) : null,
						(0, react_jsx_runtime$1.jsxs)("div", {
							className: c.field,
							children: [(0, react_jsx_runtime$1.jsx)("p", {
								className: c.fieldLabel,
								...
								children: [(0, react_jsx_runtime$1.jsxs)("button", {
									...
									children: [(0, react_jsx_runtime$1.jsx)("input", {
										...
										checked: mode === "move",
										readOnly: true
									}), (0, react_jsx_runtime$1.jsx)("span", { children: t("migrateModeMove") })]
								}), (0, react_jsx_runtime$1.jsxs)("button", {
									type: "button",
									className: c.scopeOption,
									...
									children: [(0, react_jsx_runtime$1.jsx)("input", {
										...
										checked: mode === "copy",
										readOnly: true
									}), (0, react_jsx_runtime$1.jsx)("span", { children: t("migrateModeCopy") })]
								})]
							})]
						}),
						from === "" ? null : result === null ? (0, react_jsx_runtime$1.jsxs)("div", {
							className: c.field,
							children: [
								(0, react_jsx_runtime$1.jsxs)("div", {
									...
									}), (0, react_jsx_runtime$1.jsx)("button", {
										type: "button",
								...
								(0, react_jsx_runtime$1.jsxs)("div", {
									...
									children: skills.length === 0 ? [(0, react_jsx_runtime$1.jsx)("p", {
										className: c.migrateHint,
										children: t("migrateNoSkills")
									}, "no-skills")] : visible.length === 0 ? [(0, react_jsx_runtime$1.jsx)("p", {
										className: c.migrateHint,
										children: t("emptySearch")
									}, "no-match")] : visible.map((skill) => (0, react_jsx_runtime$1.jsxs)("label", {
						...
						error !== null && error !== void 0 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.migrateHint,
							role: "alert",
							children: error
						}) : null,
						result !== null ? (0, react_jsx_runtime$1.jsxs)("div", {
							className: c.migrateSection,
							children: [(0, react_jsx_runtime$1.jsxs)("p", {
								className: c.migrateResult,
								"data-ok": failCount === 0 ? "true" : "false",
								children: [failCount === 0 ? (0, react_jsx_runtime$1.jsxs)("svg", {
									width: "13",
									height: "13",
									viewBox: "0 0 16 16",
									fill: "none",
									"aria-hidden": "true",
									children: [(0, react_jsx_runtime$1.jsx)("circle", {
										cx: "8",
										cy: "8",
										r: "6.5",
										stroke: "currentColor",
										strokeWidth: 1.3
									}), (0, react_jsx_runtime$1.jsx)("path", {
										d: "M5.5 8.2l1.8 1.8 3.2-4",
										stroke: "currentColor",
										strokeWidth: 1.3,
										strokeLinecap: "round",
										strokeLinejoin: "round"
									})]
								}) : (0, react_jsx_runtime$1.jsxs)("svg", {
									width: "13",
									height: "13",
									viewBox: "0 0 16 16",
									fill: "none",
									...
									children: [
										...
										(0, react_jsx_runtime$1.jsx)("circle", {
											cx: "8",
											cy: "11.6",
											r: "0.6",
											fill: "currentColor"
							...
							}), failCount > 0 ? (0, react_jsx_runtime$1.jsxs)("div", { children: [(0, react_jsx_runtime$1.jsx)("p", {
								className: c.migrateLabel,
								children: t("migrateErrors")
							}), (0, react_jsx_runtime$1.jsxs)("ul", {
								className: c.migrateResultList,
								children: result.filter((item) => item.ok !== true).map((item) => (0, react_jsx_runtime$1.jsx)("li", {
									key: item.name + "-" + (item.target ?? ""),
									children: item.name + (item.target === null || item.target === void 0 ? "" : " → " + targetLabelOf(item.target)) + "：" + (item.error ?? "")
								}, item.name + "-" + (item.target ?? "")))
							})] }) : null]
						}) : null,
						(0, react_jsx_runtime$1.jsxs)("div", {
							className: c.dialogFooter,
							children: [(0, react_jsx_runtime$1.jsx)("span", {}), (0, react_jsx_runtime$1.jsxs)("div", {
								className: c.scopeActions,
								children: result === null ? [(0, react_jsx_runtime$1.jsx)("button", {
									type: "button",
		...
		function SkillsSection(props) {
			...
			const [query, setQuery] = react$1.useState("");
			const [listState, setListState] = react$1.useState({ status: "loading" });
			const [request, setRequest] = react$1.useState(0);
			const [expanded, setExpanded] = react$1.useState(null);
			const [collapsed, setCollapsed] = react$1.useState(() => /* @__PURE__ */ new Set());
			...
			const [bodies, setBodies] = react$1.useState({});
			const [ops, setOps] = react$1.useState({});
			const [adding, setAdding] = react$1.useState({ status: "idle" });
			const [dragActive, setDragActive] = react$1.useState(false);
			const [wsOptions, setWsOptions] = react$1.useState(null);
			const [scopeFilter, setScopeFilter] = react$1.useState("global");
			const [migrator, setMigrator] = react$1.useState(null);
			const [updateBanner, setUpdateBanner] = react$1.useState(null);
			const [confirmKey, setConfirmKey] = react$1.useState(null);
			const [addMenuOpen, setAddMenuOpen] = react$1.useState(false);
			const inflight = react$1.useRef(/* @__PURE__ */ new Set());
			const singleFileInput = react$1.useRef(null);
			const zipFileInput = react$1.useRef(null);
			react$1.useEffect(() => {
				let current = true;
			...
			const applySetEnabled = (skill) => {
				...
				Promise.resolve().then(() => setSkillEnabled(skill.name, target, scopeOf(skill))).then(() => {
					...
					setOps((prev) => ({
						...prev,
						[opKeyOf(skill)]: { status: "ok" }
					}));
					reloadAfterHot();
				}, () => {
					setOps((prev) => ({
						...prev,
						[opKeyOf(skill)]: { status: "error" }
					}));
				});
			};
			const applyRemove = (skill) => {
				...
				Promise.resolve().then(() => removeSkill(skill.name, scopeOf(skill))).then(() => {
					setListState((prev) => prev.status === "ready" ? {
						status: "ready",
						skills: prev.skills.filter((s) => opKeyOf(s) !== key)
					} : prev);
					setOps((prev) => ({
						...prev,
						[key]: { status: "ok" }
			...
			react$1.useEffect(() => {
				...
				const timer = setTimeout(() => setConfirmKey(null), 3e3);
			...
			const opKeyOf = (skill) => skill.name + "\0" + (skill.scope !== void 0 && skill.scope !== null && skill.scope.kind === "workspace" ? skill.scope.path : "global");
			const runAdd = (kind, items) => {
				...
				Promise.all(items.map((item) => readFileAsBase64(item.file))).then((blobs) => {
					const payloadFiles = items.map((item, index) => ({
			...
			const readHandleDir = async (handle, prefix, out) => {
				for await (const [name, child] of handle.entries()) if (child.kind === "file") {
				...
				} else if (child.kind === "directory") await readHandleDir(child, prefix === "" ? name : prefix + "/" + name, out);
			};
			...
			const collectDropItems = async (dataTransfer) => {
				...
				const walk = async (entry, prefix) => {
					...
					} else if (entry.isDirectory) for (const child of await readDirEntries(entry)) await walk(child, prefix + entry.name + "/");
				};
				const entries = [];
				...
				if (entries.length === 0) for (const file of dataTransfer.files) items.push({
					name: file.name,
					path: file.name,
					file
				});
				else for (const entry of entries) await walk(entry, "");
				return items;
			};
			const onDrop = (event) => {
			...
			const scopeOf = (skill) => skill.scope !== void 0 && skill.scope !== null && skill.scope.kind === "workspace" ? skill.scope.path : "global";
			const labelOf = (path) => {
				const hit = (Array.isArray(wsOptions) ? wsOptions : []).find((workspace) => workspace.path === path);
				if (hit !== void 0 && typeof hit.label === "string" && hit.label !== "") return hit.label;
			...
			const renderCard = (skill) => {
				...
				return (0, react_jsx_runtime$1.jsxs)("li", {
					key: skill.name,
					className: c.card,
					...
					children: [(0, react_jsx_runtime$1.jsxs)("button", {
						...
						children: [
							...
							(0, react_jsx_runtime$1.jsxs)("span", {
					...
					}), open ? (0, react_jsx_runtime$1.jsxs)("div", {
						className: c.cardDetails,
						children: [
							(0, react_jsx_runtime$1.jsxs)("p", {
								className: c.meta,
								children: [skill.description, (0, react_jsx_runtime$1.jsx)("span", {
									className: c.metaProvider,
									children: t("providerLabel") + ": " + skill.provider
								})]
							}),
							body === void 0 || body.status === "loading" ? (0, react_jsx_runtime$1.jsx)("p", {
								className: c.status,
								children: t("contentLoading")
							}) : null,
							body !== void 0 && body.status === "error" ? (0, react_jsx_runtime$1.jsx)("p", {
								className: c.failureText,
								children: t("contentError")
							}) : null,
							body !== void 0 && body.status === "missing" ? (0, react_jsx_runtime$1.jsx)("p", {
								className: c.failureText,
								children: t("contentMissing")
							}) : null,
							body !== void 0 && body.status === "ready" ? (0, react_jsx_runtime$1.jsx)("div", {
								className: c.contentBox,
								children: (0, react_jsx_runtime$1.jsx)("pre", {
									className: c.content,
									children: body.skill.content
								})
							}) : null,
							editable ? (0, react_jsx_runtime$1.jsxs)("div", {
								className: c.cardActions,
								children: [
									(0, react_jsx_runtime$1.jsxs)("span", {
										className: c.switchRow,
										children: [(0, react_jsx_runtime$1.jsx)("button", {
											type: "button",
											role: "switch",
											className: c.switch,
											...
											children: (0, react_jsx_runtime$1.jsx)("span", { className: c.switchThumb })
										}), (0, react_jsx_runtime$1.jsx)("span", {
											className: c.switchText,
											children: enabled ? t("switchDisable") : t("switchEnable")
										})]
									}),
									op?.status === "error" ? (0, react_jsx_runtime$1.jsx)("span", {
										className: c.opError,
										children: t("opFailed")
									}) : null,
									(0, react_jsx_runtime$1.jsx)("button", {
			...
			const renderFolder = (folder) => (0, react_jsx_runtime$1.jsxs)("li", {
				...
				}), !collapsed.has(folder.path) ? (0, react_jsx_runtime$1.jsx)("ul", {
					className: c.cards,
			...
			const toggle = (skill) => {
				...
				setExpanded(next);
				if (next === null || bodies[key] !== void 0 || inflight.current.has(key)) return;
				...
				Promise.resolve().then(() => loadContent(skill.name, scopeOf(skill))).then((skillBody) => {
					...
					setBodies((prev) => ({
						...prev,
						[key]: {
							status: skillBody === null ? "missing" : "ready",
							skill: skillBody
						}
					}));
				}, () => {
			...
			return (0, react_jsx_runtime$1.jsx)("div", {
				...
				onDragLeave,
				onDrop,
				children: listState.status === "loading" ? (0, react_jsx_runtime$1.jsx)("p", {
					className: c.status,
					children: t("loading")
				}) : listState.status === "error" ? (0, react_jsx_runtime$1.jsxs)("div", {
					className: c.failure,
					children: [(0, react_jsx_runtime$1.jsx)("p", {
						role: "alert",
						children: t("error")
					...
					className: c.catalog,
					children: [
						dragActive ? (0, react_jsx_runtime$1.jsx)("div", {
							className: c.dropHint,
							children: t("addDragHint")
						}) : null,
						updateBanner !== null ? (0, react_jsx_runtime$1.jsxs)("div", {
							className: c.notice,
							"data-kind": "info",
							role: "status",
						...
						(0, react_jsx_runtime$1.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime$1.jsx)("h3", { children: t("catalog") }),
								(0, react_jsx_runtime$1.jsx)("span", {
								...
								(0, react_jsx_runtime$1.jsxs)("span", {
									...
									children: [(0, react_jsx_runtime$1.jsx)("button", {
										...
										children: (0, react_jsx_runtime$1.jsxs)("svg", {
											width: "14",
											height: "14",
											viewBox: "0 0 16 16",
											fill: "none",
											"aria-hidden": "true",
											children: [(0, react_jsx_runtime$1.jsx)("path", {
										...
										}), addMenuOpen ? (0, react_jsx_runtime$1.jsxs)("div", {
											className: c.addMenu,
											children: [
												(0, react_jsx_runtime$1.jsx)("p", {
						...
						(0, react_jsx_runtime$1.jsxs)("div", {
							...
							children: scopeKeys.map((key) => (0, react_jsx_runtime$1.jsxs)("button", {
								type: "button",
						...
						adding.status === "busy" ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.addStatus,
							children: t("addBusy")
						}) : null,
						adding.status === "error" ? (0, react_jsx_runtime$1.jsxs)("div", {
							className: c.notice,
							"data-kind": "error",
							role: "alert",
							children: [(0, react_jsx_runtime$1.jsx)("span", {
						...
						currentSessionId() === void 0 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.status,
							children: t("noSession")
						}) : null,
						skills.length === 0 && currentSessionId() !== void 0 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.status,
							children: t("empty")
						}) : null,
						skills.length > 0 && scoped.length === 0 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.status,
							children: t("emptyScope")
						}) : null,
						scoped.length > 0 && filtered.length === 0 ? (0, react_jsx_runtime$1.jsx)("p", {
							className: c.status,
							children: t("emptySearch")
						}) : null,
						filtered.length > 0 ? (0, react_jsx_runtime$1.jsx)("ul", {
							className: c.cards,
						...
						migrator !== null ? (0, react_jsx_runtime$1.jsx)(MigrateDialog, {
							t,
							options: wsOptions,
							from: migrator.from,
							setFrom: (value) => {
		...
		function formFromServer(server) {
			...
			form.cwd = server.cwd ?? "";
			form.url = server.url ?? "";
			form.timeout = String(server.toolCallTimeoutMs ?? 6e4);
			...
			form.maxDelay = String(server.reconnect?.maxDelayMs ?? 3e4);
		...
		function buildMcpInput(form, deletedEnv, deletedHeaders) {
			const reconnect = {
				...
				maxDelayMs: mcpNumber(form.maxDelay, 3e4),
				maxAttempts: mcpNumber(form.maxAttempts, 10)
			};
			const common = {
				serverName: String(form.serverName ?? "").trim(),
				toolCallTimeoutMs: mcpNumber(form.timeout, 6e4),
		...
		function McpFormDialog({ t, initial, onSave, onCancel, busy, error }) {
			const editing = initial !== null && initial !== void 0;
			const [form, setForm] = react$1.useState(() => editing ? formFromServer(initial) : defaultMcpForm());
			const [deletedEnv, setDeletedEnv] = react$1.useState(() => /* @__PURE__ */ new Set());
			const [deletedHeaders, setDeletedHeaders] = react$1.useState(() => /* @__PURE__ */ new Set());
			const [advancedOpen, setAdvancedOpen] = react$1.useState(false);
			...
			const submit = () => {
				onSave(buildMcpInput(form, deletedEnv, deletedHeaders), editing ? initial.serverName : void 0);
			};
			const label = (text) => (0, react_jsx_runtime$1.jsx)("span", {
				className: m.label,
				children: text
			});
			const field = (text, node, wide) => (0, react_jsx_runtime$1.jsxs)("label", {
				className: m.field,
				"data-wide": wide ? "true" : void 0,
				children: [label(text), node]
			});
			const textInput = (value, onChange, placeholder = "") => (0, react_jsx_runtime$1.jsx)("input", {
				className: m.input,
				value,
				placeholder,
				onChange: (event) => onChange(event.target.value)
			});
			const textArea = (value, onChange, placeholder = "") => (0, react_jsx_runtime$1.jsx)("textarea", {
				className: m.textarea,
				value,
				placeholder,
				onChange: (event) => onChange(event.target.value)
			});
			const secretEditor = (keys, deleted, setDeleted, text, setText, placeholder) => (0, react_jsx_runtime$1.jsxs)(react_jsx_runtime$1.Fragment, { children: [keys.length > 0 ? (0, react_jsx_runtime$1.jsx)("div", {
				className: m.secretKeys,
				children: keys.map((key) => (0, react_jsx_runtime$1.jsxs)("span", {
					className: m.key,
					children: [key, (0, react_jsx_runtime$1.jsx)("button", {
						type: "button",
						onClick: () => {
			...
			}) : null, textArea(text, setText, placeholder)] });
			const fields = [field(t("fieldServerName"), textInput(form.serverName, (value) => set({ serverName: value }), "MCP Server"), false), field(t("fieldTransport"), (0, react_jsx_runtime$1.jsxs)("div", {
			...
			fields.push((0, react_jsx_runtime$1.jsx)("div", {
				className: m.field,
				"data-wide": "true",
				children: (0, react_jsx_runtime$1.jsx)("button", {
					type: "button",
			...
			if (advancedOpen) {
				fields.push(field(t("fieldFailOnStartup"), (0, react_jsx_runtime$1.jsxs)("label", {
				...
				fields.push(field(t("fieldReconnect"), (0, react_jsx_runtime$1.jsxs)("label", {
					className: m.checkRow,
					children: [(0, react_jsx_runtime$1.jsx)("input", {
						type: "checkbox",
			...
			return (0, react_jsx_runtime$1.jsx)("div", {
				...
				children: (0, react_jsx_runtime$1.jsxs)("div", {
					className: c.scopeBox,
					children: [
						(0, react_jsx_runtime$1.jsx)("h4", { children: editing ? t("editTitle") : t("newTitle") }),
						(0, react_jsx_runtime$1.jsx)("div", {
							className: m.form,
							children: fields
						}),
						error !== void 0 && error !== null ? (0, react_jsx_runtime$1.jsx)("div", {
							className: c.notice,
							"data-kind": "error",
							children: (0, react_jsx_runtime$1.jsx)("span", {
								className: c.noticeText,
		...
		function McpSection({ t, listMcp, saveMcp, removeMcp, setEnabledMcp, testMcp, reloadMcp, checkUpdateRemote }) {
			const [loadState, setLoadState] = react$1.useState({ kind: "loading" });
			const [data, setData] = react$1.useState(null);
			const [request, setRequest] = react$1.useState(0);
			const [editing, setEditing] = react$1.useState(null);
			const [dialogBusy, setDialogBusy] = react$1.useState(false);
			const [updateBanner, setUpdateBanner] = react$1.useState(null);
			const [dialogError, setDialogError] = react$1.useState(null);
			const [confirming, setConfirming] = react$1.useState(null);
			const [testing, setTesting] = react$1.useState(null);
			const [testResult, setTestResult] = react$1.useState(null);
			react$1.useEffect(() => {
				let cancelled = false;
				listMcp().then((value) => {
					if (cancelled) return;
			...
			const applySave = async (input, previousServerName) => {
				...
				setDialogError(null);
				try {
					await saveMcp(input, previousServerName);
					setEditing(null);
			...
			const applyToggle = async (server) => {
				...
				setData((prev) => prev === null ? prev : {
					...prev,
					servers: prev.servers.map((item) => item.serverName === server.serverName ? {
						...item,
						enabled: wanted
					} : item)
				});
				try {
					...
					setData((prev) => prev === null ? prev : {
						...prev,
						servers: prev.servers.map((item) => item.serverName === next.serverName ? next : item)
					});
				} catch (error) {
					setData((prev) => prev === null ? prev : {
						...prev,
			...
			const applyRemove = async (server) => {
				...
				try {
					...
					setData((prev) => prev === null ? prev : {
						...prev,
						servers: prev.servers.filter((item) => item.serverName !== server.serverName)
					});
				} catch (error) {
					setLoadState({
						kind: "error",
			...
			const gearIcon = (0, react_jsx_runtime$1.jsxs)("svg", {
				width: 14,
				height: 14,
				viewBox: "0 0 24 24",
				fill: "none",
				...
				children: [(0, react_jsx_runtime$1.jsx)("circle", {
					...
					cy: 12,
					r: 3
				}), (0, react_jsx_runtime$1.jsx)("path", { d: "M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" })]
			});
			const serverCard = (server, isExternal) => {
				stateLabel(server);
				server.enabled && server.fiberPhase;
				server.fiberPhase;
				return (0, react_jsx_runtime$1.jsxs)("div", {
					className: m.card,
					children: [
						(0, react_jsx_runtime$1.jsxs)("div", {
							className: m.cardTop,
							children: [
								...
								(0, react_jsx_runtime$1.jsxs)("span", {
									...
									children: [(0, react_jsx_runtime$1.jsx)("span", {
										className: m.badge,
										children: server.transport === "streamable-http" ? "HTTP" : "STDIO"
									}), isExternal ? (0, react_jsx_runtime$1.jsx)("span", {
										className: m.badge,
										children: t("external")
									}) : null]
								}),
								(0, react_jsx_runtime$1.jsx)("span", { className: m.spacer }),
								isExternal ? null : (0, react_jsx_runtime$1.jsx)("button", {
									type: "button",
									className: m.iconBtn,
						...
						(0, react_jsx_runtime$1.jsxs)("div", {
							...
							}), (0, react_jsx_runtime$1.jsx)("span", { children: t !== null ? t("toolCount").replace("{count}", String(server.toolCount ?? 0)) : "" })]
						}),
						isExternal ? null : (0, react_jsx_runtime$1.jsxs)("div", {
							className: m.actions,
							children: [
								(0, react_jsx_runtime$1.jsxs)("span", {
									className: c.switchRow,
									children: [(0, react_jsx_runtime$1.jsx)("button", {
										...
										className: c.switchText,
										children: t !== null ? server.enabled ? t("stateEnabled") : t("stateDisabled") : ""
									})]
								}),
								(0, react_jsx_runtime$1.jsx)("span", { className: m.spacer }),
								(0, react_jsx_runtime$1.jsx)("button", {
								...
								confirming === server.serverName ? (0, react_jsx_runtime$1.jsxs)(react_jsx_runtime$1.Fragment, { children: [(0, react_jsx_runtime$1.jsx)("button", {
									type: "button",
									className: m.actionBtn,
						...
						testResult?.serverName === server.serverName ? (0, react_jsx_runtime$1.jsxs)("div", {
							className: m.result,
							"data-ok": testResult.result.ok ? "true" : "false",
							children: [testResult.result.ok ? t !== null ? t("testOk").replace("{count}", String(testResult.result.tools?.length ?? 0)) : "" : t !== null ? t("testFailed") + " " + (testResult.result.error ?? "") : "", testResult.result.ok && Array.isArray(testResult.result.tools) ? (0, react_jsx_runtime$1.jsx)("div", { children: testResult.result.tools.map((tool) => tool.name).join(", ") }) : null]
						}) : null
					]
			...
			return (0, react_jsx_runtime$1.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime$1.jsxs)("div", {
						className: m.head,
						children: [(0, react_jsx_runtime$1.jsx)("h3", { children: t !== null ? t("title") : "" }), (0, react_jsx_runtime$1.jsx)("button", {
							type: "button",
							className: m.actionBtn,
							onClick: () => {
								reloadMcp().then((value) => {
									setData(value);
								}).catch(() => refresh(true));
							},
					...
					patch?.ok === false ? (0, react_jsx_runtime$1.jsxs)("div", {
						className: c.notice,
						"data-kind": "error",
						children: [(0, react_jsx_runtime$1.jsx)("span", {
							className: c.noticeText,
							children: t !== null ? t("patchBroken") + " " + (patch.error ?? "") : ""
						}), (0, react_jsx_runtime$1.jsx)("button", {
							type: "button",
							className: c.noticeButton,
					...
					loadState.kind === "error" ? (0, react_jsx_runtime$1.jsxs)("div", {
						className: c.notice,
						"data-kind": "error",
						children: [(0, react_jsx_runtime$1.jsx)("span", {
							className: c.noticeText,
					...
					loadState.kind === "loading" && servers.length === 0 ? (0, react_jsx_runtime$1.jsx)("p", {
						className: m.sub,
						children: t !== null ? t("loading") : ""
					}) : null,
					servers.length === 0 && external.length === 0 && loadState.kind === "ready" ? (0, react_jsx_runtime$1.jsx)("p", {
						className: m.sub,
						children: t !== null ? t("empty") : ""
					}) : null,
					(0, react_jsx_runtime$1.jsxs)("div", {
						className: m.cards,
						children: [...servers.map((server) => serverCard(server, false)), ...external.map((server) => serverCard(server, true))]
					}),
					editing !== null ? (0, react_jsx_runtime$1.jsx)(McpFormDialog, {
						t: t !== null ? t : (key) => key,
		...
		function workbenchIcon(path, tag) {
			return function WorkbenchIcon(props) {
				...
				return (0, react_jsx_runtime$1.jsx)("svg", {
					...
					"aria-hidden": "true",
					focusable: "false",
					className: props !== null && props !== void 0 ? props.className : void 0,
		...
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "dsh-better-workbench-skill-mcp-panels: skill dictionaries");
			ctx.effect(() => ctx.locale.register(MCP_NS, {
				zh: mcpZh,
				en: mcpEn
			}), "dsh-better-workbench-skill-mcp-panels: mcp dictionaries");
			...
			const currentSessionId = () => {
				...
				const snapshot = store !== null && typeof store === "object" && typeof store.getSnapshot === "function" ? store.getSnapshot() : void 0;
			...
			const callRemote = async (method, ...args) => {
				await mount;
				const result = await ctx.get("remote.skillsViewer")[method](...args);
			...
			const callMcp = async (method, ...args) => {
				await mount;
				const result = await ctx.get("remote.mcpManager")[method](...args);
			...
			const mcpSectionFace = () => ({
				...
				saveMcp: (input, previousServerName) => callMcp("save", {
					input,
					previousServerName
				}),
				removeMcp: (serverName) => callMcp("removeServer", { serverName }),
				setEnabledMcp: (serverName, enabled) => callMcp("setEnabled", {
					serverName,
					enabled
				}),
			...
			const workbenchPage = (app, Section, face) => function WorkbenchPage(props) {
				return (0, react_jsx_runtime$1.jsx)("div", {
					...
					children: (0, react_jsx_runtime$1.jsx)(Section, {
						...props,
						...face
					})
				});
			...
			const registerWorkbenchPage = (definition) => ctx.effect(() => ctx.workbench.registerApp({
				protocolVersion: 1,
				allowMultiple: false,
			...
			registerWorkbenchPage({
				...
				defaultInstance: {
					instanceId: "dsh-better-workbench-skill-mcp-panels-skills",
					title: t("nav")
				},
			...
			registerWorkbenchPage({
				...
				defaultInstance: {
					instanceId: "dsh-better-workbench-skill-mcp-panels-mcp",
					title: mt("nav")
				},
