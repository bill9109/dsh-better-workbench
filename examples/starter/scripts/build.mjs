...
if (args.includes('--dry-run')) {
  console.log('Typecheck and build host ESM/client factory using installed dsh-workbench/build/client-bundle; no checkout required.')
} else {
  ...
  try {
    ...
    const { packageBundles } = await import('dsh-workbench/build/client-bundle')
