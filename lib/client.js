window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function WorkbenchAppIcon({ renderer: Renderer, className }) {
		...
		function WorkbenchRow({ instance, appIcon, compact, active, draggable, dropPosition, busy, canMoveUp, canMoveDown, onMove, onOpen, onRename, onDelete, onDragStart, onDragOver, onDrop, onDragEnd }) {
