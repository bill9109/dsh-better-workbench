window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const LEGACY_KEYS = [
			"dsh-workbench.state.v3",
			"dsh-workbench.state.v2",
			"dsh-workbench.instances.v1"
		];
		...
		var WorkbenchController = class {
			...
			drain(tasks, label) {
				...
				result.catch((error) => console.error("[dsh-workbench]", error));
				return result;
			}
			assertActive() {
		...
		function WorkbenchSidebar({ service }) {
			...
			const renameDialog = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: [
					...
					renameError !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-workbench-rename-error",
						role: "alert",
			...
			const deleteDialog = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				footer: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					...
					variant: "outline",
					className: "dsh-workbench-delete-action",
					disabled: deleting,
				...
				children: [deleting && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					className: "dsh-workbench-delete-error",
					role: "alert",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					snapshot.recovery && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						role: "alert",
						className: "dsh-workbench-frame-error",
						children: [
		...
		function SurfaceToolbar({ service, title, presentation, app, onMode, exporting, onExport }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
				className: "dsh-workbench-frame-toolbar",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
						label: "工作台首页",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsh-workbench-frame-button",
							"aria-label": "工作台首页",
							onClick: () => {
								service.openHome();
							},
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-workbench-frame-title",
						title,
						children: title
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-workbench-frame-modes",
						role: "group",
						"aria-label": "显示模式",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					presentation.kind !== "page" && app?.source !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
						className: "dsh-workbench-frame-source",
						children: [
					...
					exporting && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-workbench-frame-status",
						role: "status",
						children: "正在导出..."
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-workbench-save-status",
						role: "status",
						"aria-live": "polite",
						"aria-atomic": "true",
		...
		function WorkbenchSurface({ service }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: presentation.kind === "page" ? frame : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("aside", {
					className: presentation.kind === "panel" ? "dsh-workbench-panel" : "dsh-workbench-capsule",
