...
function WorkbenchHomeRow({ active, onOpen }) {
    return (_jsxs("button", { type: "button", className: "dsh-better-workbench-sidebar-row dsh-better-workbench-sidebar-home", "data-active": active, onClick: onOpen, children: [_jsx(WorkbenchHomeIcon, { className: "dsh-better-workbench-sidebar-home-icon" }), _jsx("span", { className: "dsh-better-workbench-sidebar-row-label", children: "\u9996\u9875" })] }));
}
function ViewOptionsMenu({ orderBy, onOrderPick }) {
    ...
    return (_jsx(Menu, { open: open, onClose: () => { setOpen(false); }, items: [
            ...
            if (id === 'manual' || id === 'updated')
                onOrderPick(id);
            setOpen(false);
        }, align: "end", dense: true, portal: true, anchor: (_jsx(Tooltip, { label: "\u89C6\u56FE\u9009\u9879", side: "bottom", delayMs: 500, children: _jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-icon-button dsh-better-workbench-sidebar-wide-only", "aria-label": "\u89C6\u56FE\u9009\u9879", onClick: () => { setOpen(value => !value); }, children: _jsx(IconPersonalizationOutline16, {}) }) })) }));
}
function WorkbenchRow({ instance, compact, active, draggable, dropPosition, onOpen, onRename, onDelete, onDragStart, onDragOver, onDrop, onDragEnd, }) {
    ...
    return (_jsxs("div", { className: "dsh-better-workbench-sidebar-row", "data-active": active, "data-menu-open": menuOpen, "data-drop-position": dropPosition ?? undefined, role: "button", tabIndex: compact ? -1 : 0, draggable: draggable, onClick: onOpen, onKeyDown: event => {
            if (event.key === 'Enter' || event.key === ' ') {
                event.preventDefault();
                onOpen();
            }
        }, onDragStart: onDragStart, onDragOver: onDragOver, onDrop: onDrop, onDragEnd: onDragEnd, children: [compact && _jsx(IconPersonalizationOutline16, { className: "dsh-better-workbench-sidebar-rail-icon" }), _jsx("span", { className: "dsh-better-workbench-sidebar-row-label", children: instance.title }), !compact && (_jsx("span", { className: "dsh-better-workbench-sidebar-row-actions", children: _jsx(Menu, { open: menuOpen, onClose: () => { setMenuOpen(false); }, items: [
                        ...
                        if (id === 'delete')
                            onDelete();
                    }, dense: true, portal: true, closeOnPointerLeave: true, anchor: (_jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-row-action", "aria-label": `工作台“${instance.title}”的操作`, title: "\u66F4\u591A\u64CD\u4F5C", onClick: event => { event.stopPropagation(); setMenuOpen(value => !value); }, children: _jsx(IconEllipsisOutline16, {}) })) }) }))] }));
}
...
export function WorkbenchSidebar({ service }) {
    ...
    const renameDialog = (_jsxs(Modal, { open: renameTarget !== null, onClose: closeRename, closeLabel: "\u5173\u95ED", title: "\u91CD\u547D\u540D\u5DE5\u4F5C\u53F0", footer: (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "outline", disabled: renaming, onClick: closeRename, children: "\u53D6\u6D88" }), _jsx(Button, { variant: "primary", disabled: renameBlocked, onClick: confirmRename, children: "\u91CD\u547D\u540D" })] })), children: [_jsx("input", { className: "dsh-better-workbench-rename-input", value: renameDraft, "aria-label": "\u5DE5\u4F5C\u53F0\u540D\u79F0", autoFocus: true, disabled: renaming, onFocus: event => { event.target.select(); }, onChange: event => { setRenameDraft(event.target.value); setRenameError(null); }, onCompositionStart: () => { composingRef.current = true; }, onCompositionEnd: () => { composingRef.current = false; }, onKeyDown: event => {
                    if (event.key === 'Enter' && !composingRef.current) {
                        event.preventDefault();
                        event.stopPropagation();
                        confirmRename();
                    }
                } }), renameError !== null && _jsx("div", { className: "dsh-better-workbench-rename-error", role: "alert", children: renameError })] }));
    const deleteDialog = (_jsx(Modal, { open: deleteTarget !== null, onClose: closeDelete, closeLabel: "\u5173\u95ED", title: "\u5220\u9664\u5DE5\u4F5C\u53F0\uFF1F", ...deleteTarget === null
            ? {}
            : { description: '删除“' + deleteTarget.title + '”？只移除工作台入口和配置，不会删除应用源码或项目文件。' }, footer: (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "outline", disabled: deleting, onClick: closeDelete, children: "\u53D6\u6D88" }), _jsxs(Button, { variant: "outline", className: "dsh-better-workbench-delete-action", disabled: deleting, onClick: confirmDelete, children: [_jsx(IconTrashOutline16, { size: 16 }), "\u5220\u9664"] })] })), children: deleteError !== null && _jsx("div", { className: "dsh-better-workbench-delete-error", role: "alert", children: deleteError }) }));
    if (compact) {
        return (_jsxs("section", { ref: section, className: "dsh-better-workbench-sidebar-section", "aria-label": "\u5DE5\u4F5C\u53F0", "data-compact": "true", children: [renameDialog, deleteDialog] }));
    }
    return (_jsxs("section", { ref: section, className: "dsh-better-workbench-sidebar-section", "aria-label": "\u5DE5\u4F5C\u53F0", children: [_jsxs("div", { className: "dsh-better-workbench-sidebar-heading", children: [_jsx("span", { className: `dsh-better-workbench-sidebar-heading-label${searchExpanded && !compact ? ' is-hidden' : ''}`, children: "\u5DE5\u4F5C\u53F0" }), _jsx("div", { ref: searchRoot, className: `dsh-better-workbench-sidebar-search-slot${searchExpanded ? ' is-expanded' : ''}`, children: _jsxs("div", { className: "dsh-better-workbench-sidebar-search", children: [_jsx(Tooltip, { label: "\u641C\u7D22\u5DE5\u4F5C\u53F0", side: "bottom", delayMs: 500, disabled: searchExpanded, children: _jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-search-button", "aria-label": "\u641C\u7D22\u5DE5\u4F5C\u53F0", "aria-expanded": searchExpanded, onClick: () => {
                                            setSearchExpanded(true);
                                            if (compact)
                                                requestSidebarExpand();
                                        }, children: _jsx(IconSearchOutline16, { size: searchExpanded ? 11 : 14 }) }) }), _jsx("input", { ref: searchInput, className: "dsh-better-workbench-sidebar-search-input", type: "text", placeholder: "\u641C\u7D22\u5DE5\u4F5C\u53F0\u2026", value: query, tabIndex: searchExpanded && !compact ? 0 : -1, onChange: event => { setQuery(event.target.value); }, onKeyDown: event => {
                                        if (event.key === 'Escape') {
                                            setQuery('');
                                            setSearchExpanded(false);
                                        }
                                    } }), searchExpanded && (_jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-search-clear", "aria-label": "\u6E05\u9664\u641C\u7D22", onClick: event => {
                                        event.stopPropagation();
                                        setQuery('');
                                        setSearchExpanded(false);
                                    }, children: _jsx(IconCloseFill14, {}) }))] }) }), _jsxs("div", { className: `dsh-better-workbench-sidebar-heading-actions${searchExpanded && !compact ? ' is-hidden' : ''}`, children: [_jsx(ViewOptionsMenu, { orderBy: orderBy, onOrderPick: setOrderBy }), _jsx(Tooltip, { label: "\u521B\u5EFA\u5DE5\u4F5C\u53F0", side: "bottom", delayMs: 500, children: _jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-icon-button dsh-better-workbench-sidebar-add", "aria-label": "\u521B\u5EFA\u5DE5\u4F5C\u53F0", onClick: () => {
                                        setSearchExpanded(false);
                                        service.openHome();
                                    }, children: _jsx(IconProjectAddOutline16, { size: 16 }) }) })] })] }), compact && (_jsx("div", { className: "dsh-better-workbench-sidebar-rail-search", children: _jsx(Tooltip, { label: "\u641C\u7D22\u5DE5\u4F5C\u53F0", side: "right", delayMs: 500, children: _jsx("button", { type: "button", className: "dsh-better-workbench-sidebar-search-button", "aria-label": "\u641C\u7D22\u5DE5\u4F5C\u53F0", "aria-expanded": searchExpanded, onClick: () => {
                            setSearchExpanded(true);
                            requestSidebarExpand();
                        }, children: _jsx(IconSearchOutline16, { size: 18 }) }) }) })), _jsxs("div", { className: "dsh-better-workbench-sidebar-list", "aria-label": "\u5DE5\u4F5C\u53F0\u5217\u8868", children: [_jsx(WorkbenchHomeRow, { active: snapshot.route.kind === 'workbench-home', onOpen: () => { service.openHome(); } }), instances.map(instance => (_jsx(WorkbenchRow, { instance: instance, compact: compact, active: snapshot.route.kind === 'workbench-instance' && snapshot.route.instanceId === instance.instanceId, draggable: orderBy === 'manual', dropPosition: dropTarget?.id === instance.instanceId ? dropTarget.position : null, onOpen: () => { service.open(instance.instanceId); }, onRename: () => { requestRename(instance); }, onDelete: () => { requestDelete(instance); }, onDragStart: event => {
                        ...
                        }, onDrop: event => { handleDrop(instance.instanceId, event); }, onDragEnd: () => { setDraggedId(null); setDropTarget(null); } }, instance.instanceId)))] }), instances.length === 0 && (_jsx("div", { className: "dsh-better-workbench-sidebar-empty", children: normalizedQuery === '' ? '从首页创建实例。' : '无匹配工作台' })), renameDialog, deleteDialog] }));
}
