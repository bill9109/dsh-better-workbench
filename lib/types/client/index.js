...
function insertSidebar(service) {
    ...
    host.setAttribute('data-dsh-better-workbench-sidebar', '');
...
function insertCenter(service) {
    ...
    const host = document.createElement('div');
    host.setAttribute('data-dsh-better-workbench-center', '');
...
function createMount(service) {
    ...
    const clickHandler = (event) => {
        ...
        if (target === null || target.closest('[data-dsh-better-workbench-sidebar]') !== null)
            return;
...
export function apply(ctx) {
    ...
    ctx.effect(() => mount(service), 'dsh-better-workbench: DOM surfaces');
}
