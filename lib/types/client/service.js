const STORAGE_KEY = 'dsh-better-workbench.state.v3';
const PREVIOUS_STORAGE_KEY = 'dsh-better-workbench.state.v2';
const LEGACY_STORAGE_KEY = 'dsh-better-workbench.instances.v1';
    ...
    rebuild(persist) {
        ...
        for (const listener of [...this.listeners]) {
            try {
                ...
                console.error('[dsh-better-workbench] snapshot listener failed', error);
            }
        }
    }
    persist() {
