...
export type WorkbenchTemplateSummary = WorkbenchTemplateDefinition & { available: boolean }
...
export interface WorkbenchService {
  ...
  startCreation(templateId: string, options?: { title?: string; config?: WorkbenchConfig }): Promise<WorkbenchCreationResult>
...
export type WorkbenchClientContext = CordisContext & { workbench: WorkbenchService }
